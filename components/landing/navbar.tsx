        ...
        <div className="flex h-16 items-center justify-between">
          ...
          >
            <div className="flex size-8 items-center justify-center rounded-md border border-border bg-muted/50 transition-all duration-300 group-hover:border-primary/30 group-hover:bg-primary/5 group-hover:shadow-sm">
              <Logo size={18} className="transition-transform duration-300 group-hover:scale-110" />
            </div>
            <span className="text-lg">Snippy</span>
          </Link>
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="hidden items-center gap-2 sm:flex">
              ...
              <Button asChild size="sm" className="transition-all duration-300 hover:scale-105 hover:shadow-md">
